...
import com.gan.api.admin.param.AdminLoginParam;
import com.gan.api.admin.param.UpdateAdminNameParam;
import com.gan.api.admin.param.UpdateAdminPasswordParam;
...
public class GanAdminManageUserAPI {

    @Resource
    private AdminUserService adminUserService;

    private static final Logger logger = LoggerFactory.getLogger(GanAdminManageUserAPI.class);
